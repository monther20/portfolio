...
export function createAirplaneGeometry(): THREE.BufferGeometry {
  ...
  const vertices = new Float32Array([
    ...
    0, 0, -1.5,
    // Wing tips
    -1.2, 0.05, 0.3, 1.2, 0.05, 0.3,
    // Raised center fold
    0, 0.15, -0.5, 0, 0.12, 0.5,
    // Tail
  ...
  const indices = [
    0, 1, 3, 1, 4, 3, 1, 5, 4, 5, 7, 4, 0, 3, 2, 3, 4, 2, 4, 6, 2, 4, 7, 6, 8,
    11, 9, 8, 10, 11, 0, 8, 1, 8, 9, 1, 1, 9, 5, 0, 2, 8, 8, 2, 10, 2, 6, 10, 5,
    9, 11, 5, 11, 7, 6, 7, 11, 6, 11, 10,
  ];
