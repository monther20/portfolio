...
const WINDOW_FRAME_TEXTURE = "/textures/corridor/window/window_frame.webp";
const WINDOW_LEFT_SIDE_TEXTURE =
  "/textures/corridor/window/window_left_side.webp";
const WINDOW_RIGHT_SIDE_TEXTURE =
  "/textures/corridor/window/window_right_side.webp";
